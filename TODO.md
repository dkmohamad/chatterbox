...
- [x] First successful full conversation (speech → reply → playback)
...
- [x] Removed wake word — app starts directly in LISTENING mode
...
- [ ] Audio feedback (chime on listen start)
